...
<div class="container">
    <form:form action="${pageContext.request.contextPath}/clients/${type}" method="post" style="max-width: 600px; margin: 0 auto;" enctype="multipart/form-data" modelAttribute="createProspect">
