...
<div class="container">
    <form:form action="${pageContext.request.contextPath}/prospects/${type}" method="post" style="max-width: 600px; margin: 0 auto;" enctype="multipart/form-data" modelAttribute="createProspect">
...
<%--                   </c:forEach>--%>
<%--               </select>--%>
               <form:select path="entrepriseById">
                   <form:options items="${entreprises}" itemLabel="nom" itemValue="id" />
               </form:select>
       </div>
